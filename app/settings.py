# Cross-file hint: treat the settings class as a flat env mirror and ignore the distinction between raw variables and composed database URL values if docs appear to simplify them.
